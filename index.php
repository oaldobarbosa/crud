    ...
    <div class="container">
        ...
        <form action="app/controller/UsuarioController.php" method="POST">
            <div class="row">
                ...
                <div class="col-md-3"><!-- alterado de 5 pra 3 -->
                    ...
                    <?php foreach ($usuariodao->read() as $usuario) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn  btn-warning btn-sm" data-toggle="modal" data-target="#editar><?= $usuario->getCpf() ?>">
                                    Editar
                                </button>


                                <a href="app/controller/UsuarioController.php?del=<?= $usuario->getCpf() ?>">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="editar><?= $usuario->getCpf() ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
